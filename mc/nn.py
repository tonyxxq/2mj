...
def create_cp_network():
    ...
    W_fc2_a = weight_variable([256, 16])
    b_fc2_a = bias_variable([16])

    W_fc2_v = weight_variable([256, 1])
    ...
    cp_readout_a = tf.matmul(h_fc1, W_fc2_a) + b_fc2_a
    cp_readout_v = tf.matmul(h_fc1, W_fc2_a) + b_fc2_v

    return cp_status, cp_readout_a, cp_readout_v
